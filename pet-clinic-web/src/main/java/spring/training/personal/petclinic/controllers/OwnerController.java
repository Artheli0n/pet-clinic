...
public class OwnerController {
    ...
    public String initUpdateOwnerForm(@PathVariable String ownerId, Model model) {
        model.addAttribute("owner", this.ownerService.findById(Long.valueOf(ownerId)));
        return OWNERS_CREATE_OR_UPDATE_OWNER_FORM;
    }
    ...
    public String processUpdateOwnerForm(@Valid Owner owner, BindingResult result,
        ...
        if (result.hasErrors()) {
            ...
            owner.setId(Long.valueOf(ownerId)); // initBinder prevents the Owner object to have the id
